...
public class PostController {
    ...
    public ResponseEntity<Page<PostSummaryResponse>> getAllPostSummariesByTagId(@Parameter(hidden = true)
                                                                                @PageableDefault(sort = "createdAt,desc")
    ...
    public ResponseEntity<Page<PostSummaryResponse>> getPostSummariesByTagIdAndNickname(@Parameter(hidden = true)
                                                                                        @PageableDefault(sort = "createdAt,desc")
                                                                                        @PathVariable int tagId,
                                                                                        @PathVariable String nickname,
                                                                                        Pageable pageable
